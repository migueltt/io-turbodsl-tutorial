...
import io.turbodsl.core.logging.DefaultLoggerProvider
import kotlinx.coroutines.delay

/** Run [MainTurboDSL.main] 5 times. */
fun main() {
    // Enable internal logging to see what's going on
    System.setProperty(DefaultLoggerProvider.PROPERTY_LOGGING_LEVEL, "off")
    System.setProperty(DefaultLoggerProvider.PROPERTY_LOGGING_INTERNAL, "true")
    measure(5) {
        MainTurboDSL.main()
    }
}
